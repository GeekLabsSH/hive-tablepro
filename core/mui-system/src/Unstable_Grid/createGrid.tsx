...
import { GridOwnerState, GridTypeMap } from "./GridProps";

const defaultTheme = createTheme();

// widening Theme to any so that the consumer can own the theme structure.
const defaultCreateStyledComponent = (systemStyled as any)("div", {
  name: "MuiGrid",
  slot: "Root",
...
export default function createGrid(
  ...
  const Grid = React.forwardRef(function Grid(inProps, ref) {
    ...
    const rowSpacing =
      inProps.rowSpacing ??
      inProps.spacing ??
      (nested ? undefined : rowSpacingProp);
    const columnSpacing =
      inProps.columnSpacing ??
      inProps.spacing ??
      (nested ? undefined : columnSpacingProp);
    const ownerState = {
      ...props,
      nested,
      columns,
