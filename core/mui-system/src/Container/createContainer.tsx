import { Interpolation } from "@cronoslogistics/hive-tablepro/core/mui-material/src/styles";
...
import createTheme, { Breakpoint, Theme as DefaultTheme } from "../createTheme";
...
const useUtilityClasses = (
  ...
  return compClasses(slots, getContainerUtilityClass, classes);
};
...
>(
  ...
  const Container = React.forwardRef(function Container(inProps, ref) {
    const props: ContainerProps & { component?: React.ElementType } =
