...
export function createUnaryUnit(theme, themeKey, defaultValue, propName) {
    ...
    return (abs) => {
      ...
      if (process.env.NODE_ENV !== null) {
        if (typeof abs !== "number") {
          console.error(
            `HIVE: Expected ${propName} argument to be a number or a string, got ${abs}.`
          );
        }
      }
    ...
    return (abs) => {
      ...
      if (process.env.NODE_ENV !== null) {
        if (!Number.isInteger(abs)) {
          console.error(
            [
              `HIVE: The \`theme.${themeKey}\` array type cannot be combined with non integer values.` +
          ...
          console.error(
            [
              `HIVE: The value provided (${abs}) overflows.`,
  ...
  if (process.env.NODE_ENV !== null) {
    console.error(
      [
        `HIVE: The \`theme.${themeKey}\` value (${themeSpacing}) is invalid.`,
