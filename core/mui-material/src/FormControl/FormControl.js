...
import { isAdornedStart, isFilled } from "../InputBase/utils";
...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getFormControlUtilityClasses, classes);
};
  ...
  if (process.env.NODE_ENV !== null) {
    ...
    registerEffect = () => {
      if (registeredInput.current) {
        console.error(
          [
            "HIVE: There are multiple `InputBase` components inside a FormControl.",
