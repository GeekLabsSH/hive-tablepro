...
const useUtilityClasses = (ownerState) => {
  ...
  const composedClasses = compClasses(
    slots,
    getListItemButtonUtilityClass,
    classes
  );
  ...
  useEnhancedEffect(() => {
    if (autoFocus) {
      if (listItemRef.current) {
        ...
        console.error(
          "HIVE: Unable to set focus to a ListItemButton whose component has not been rendered."
        );
      }
    }
  }, [autoFocus]);
  ...
  return (
    <ListContext.Provider value={childContext}>
      <ListItemButtonRoot
        ...
        component={
          (other.href || other.to) && component === "div" ? "a" : component
        }
