...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getAutocompleteUtilityClass, classes);
};
...
Autocomplete.propTypes /* remove-proptypes */ = {
  ...
  defaultValue: chainPropTypes(PropTypes.any, (props) => {
    if (
      ...
      return new Error(
        [
          "HIVE: The Autocomplete expects the `defaultValue` prop to be an array when `multiple={true}` or undefined.",
  ...
  value: chainPropTypes(PropTypes.any, (props) => {
    if (
      ...
      return new Error(
        [
          "HIVE: The Autocomplete expects the `value` prop to be an array when `multiple={true}` or undefined.",
