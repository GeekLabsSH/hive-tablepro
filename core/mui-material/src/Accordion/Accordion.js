...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getAccordionUtilityClass, classes);
};
...
Accordion.propTypes /* remove-proptypes */ = {
  ...
  children: chainPropTypes(PropTypes.node.isRequired, (props) => {
    ...
    if (isFragment(summary)) {
      return new Error(
        "HIVE: The Accordion doesn't accept a Fragment as a child. " +
    ...
    if (!React.isValidElement(summary)) {
      return new Error(
        "HIVE: Expected the first child of Accordion to be a valid element."
      );
    }
