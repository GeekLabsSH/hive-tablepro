...
import { HTMLElementType } from "@cronoslogistics/hive-tablepro/core/mui-utils/src";
...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getMenuUtilityClass, classes);
};
  ...
  React.Children.map(children, (child, index) => {
    ...
    if (process.env.NODE_ENV !== null) {
      if (isFragment(child)) {
        console.error(
          [
            "HIVE: The Menu component doesn't accept a Fragment as a child.",
