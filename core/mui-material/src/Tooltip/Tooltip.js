...
import { elementAcceptingRef } from "@cronoslogistics/hive-tablepro/core/mui-utils/src";
...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getTooltipUtilityClass, classes);
};
...
const Tooltip = React.forwardRef(function Tooltip(inProps, ref) {
  ...
  if (process.env.NODE_ENV !== null) {
    ...
    React.useEffect(() => {
      if (
        ...
        console.error(
          [
            "HIVE: You are providing a disabled `button` child to the Tooltip component.",
  ...
  if (process.env.NODE_ENV !== null) {
    ...
    React.useEffect(() => {
      if (
        ...
        console.error(
          [
            "HIVE: The `children` component of the Tooltip is not forwarding its props correctly.",
  ...
  if (process.env.NODE_ENV !== null) {
    if (children.props.title) {
      console.error(
        [
          "HIVE: You have provided a `title` prop to the child of <Tooltip />.",
