...
import ClickAwayListener from "@cronoslogistics/hive-tablepro/core/mui-base/src/ClickAwayListener";
...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getSnackbarUtilityClass, classes);
};
