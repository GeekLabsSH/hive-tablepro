...
import { integerPropType } from "@cronoslogistics/hive-tablepro/core/mui-utils/src";
...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getBreadcrumbsUtilityClass, classes);
};
  ...
  const renderItemsBeforeAndAfter = (allItems) => {
    ...
    if (itemsBeforeCollapse + itemsAfterCollapse >= allItems.length) {
      if (process.env.NODE_ENV !== null) {
        console.error(
          [
            "HIVE: You have provided an invalid combination of props to the Breadcrumbs.",
    ...
    .filter((child) => {
      if (process.env.NODE_ENV !== null) {
        if (isFragment(child)) {
          console.error(
            [
              "HIVE: The Breadcrumbs component doesn't accept a Fragment as a child.",
