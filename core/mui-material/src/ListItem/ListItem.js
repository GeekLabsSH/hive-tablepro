...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getListItemUtilityClass, classes);
};
  ...
  useEnhancedEffect(() => {
    if (autoFocus) {
      if (listItemRef.current) {
        ...
        console.error(
          "HIVE: Unable to set focus to a ListItem whose component has not been rendered."
        );
      }
    }
  }, [autoFocus]);
...
ListItem.propTypes /* remove-proptypes */ = {
  ...
  children: chainPropTypes(PropTypes.node, (props) => {
    ...
    if (
      ...
      return new Error(
        "HIVE: You used an element after ListItemSecondaryAction. " +
