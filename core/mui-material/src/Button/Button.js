...
import { internal_resolveProps as resolveProps } from "@cronoslogistics/hive-tablepro/core/mui-utils/src";
...
const useUtilityClasses = (ownerState) => {
  ...
  const composedClasses = compClasses(slots, getButtonUtilityClass, classes);
