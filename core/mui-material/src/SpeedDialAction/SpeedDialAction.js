...
import { emphasize } from "@cronoslogistics/hive-tablepro/core/mui-system/src";
...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getSpeedDialActionUtilityClass, classes);
};
...
const SpeedDialAction = React.forwardRef(function SpeedDialAction(
  inProps,
  ref
) {
