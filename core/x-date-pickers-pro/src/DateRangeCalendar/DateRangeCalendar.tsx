...
} from "../internal/utils/date-range-manager";
import {
  isEndOfRange,
  isRangeValid,
  isStartOfRange,
...
const useUtilityClasses = (ownerState: DateRangeCalendarOwnerState<any>) => {
  ...
  return compClasses(slots, getDateRangeCalendarUtilityClass, classes);
};
...
const DateRangeCalendar = React.forwardRef(function DateRangeCalendar<TDate>(
  ...
  const isPreviousMonthDisabled = usePreviousMonthDisabled(
