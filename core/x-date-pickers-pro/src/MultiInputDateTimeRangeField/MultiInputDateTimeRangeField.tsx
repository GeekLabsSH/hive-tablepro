...
import Stack, {
  StackProps,
} from "@cronoslogistics/hive-tablepro/core/mui-material/src/Stack";
import {
  styled,
  useThemeProps,
...
import Typography, {
  TypographyProps,
} from "@cronoslogistics/hive-tablepro/core/mui-material/src/Typography";
import {
...
type MultiInputDateTimeRangeFieldComponent = (<TDate>(
  props: MultiInputDateTimeRangeFieldProps<TDate> &
    React.RefAttributes<HTMLInputElement>
) => JSX.Element) & { propTypes?: any };

const MultiInputDateTimeRangeField = React.forwardRef(
  function MultiInputDateTimeRangeField<TDate>(
