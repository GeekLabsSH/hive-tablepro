import { PickerViewRendererLookup } from "@cronoslogistics/hive-tablepro/core/x-date-pickers/src/internals";
...
>(inProps: StaticDateRangePickerProps<TDate>, ref: React.Ref<HTMLDivElement>) {
  ...
  const props = {
    ...
    openTo: "day" as const,
    calendars:
      defaultizedProps.calendars ??
      (displayStaticWrapperAs === "mobile" ? 1 : 2),
    slotProps: {
