...
type DateRangeFieldComponent = (<TDate>(
  props: SingleInputDateTimeRangeFieldProps<TDate> &
    React.RefAttributes<HTMLInputElement>
) => JSX.Element) & { propTypes?: any };

const SingleInputDateTimeRangeField = React.forwardRef(
  function SingleInputDateTimeRangeField<TDate>(
    inProps: SingleInputDateTimeRangeFieldProps<TDate>,
    ...
    const { slots, slotProps, components, componentsProps, ...other } =
      themeProps;
