...
import { useUtils } from "@cronoslogistics/hive-tablepro/core/x-date-pickers/src/internals";
import {
  PickersDay,
  PickersDayProps,
} from "@cronoslogistics/hive-tablepro/core/x-date-pickers/src/PickersDay";
...
const useUtilityClasses = (ownerState: OwnerState) => {
  ...
  return compClasses(slots, getDateRangePickerDayUtilityClass, classes);
};
