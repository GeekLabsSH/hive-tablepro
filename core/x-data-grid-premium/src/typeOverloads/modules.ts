import { GridKeyValue, GridValidRowModel } from "@cronoslogistics/hive-tablepro/core/x-data-grid-pro/src";
import type {
  GridApiCachesPro, GridControlledStateEventLookupPro
} from '@cronoslogistics/hive-tablepro/core/x-data-grid-pro/src/typeOverloads';
import type {
...
declare module "@cronoslogistics/hive-tablepro/core/x-data-grid-pro/src" {
...
declare module '@cronoslogistics/hive-tablepro/core/x-data-grid-pro/src/internals' {
  interface GridApiCaches extends GridApiCachesPremium { }
