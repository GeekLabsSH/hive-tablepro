...
import { buildWarning, GridStateColDef, isObject } from '@cronoslogistics/hive-tablepro/core/x-data-grid/src/internals';
...
const warnInvalidFormattedValue = buildWarning([
  'HIVE: When the value of a field is an object or a `renderCell` is provided, the Excel export might not display the value correctly.',
...
const serializeRow = (
  ...
  columns.forEach((column, colIndex) => {
    const colSpanInfo = api.unstable_getCellColSpanInfo(id, colIndex) as any;
