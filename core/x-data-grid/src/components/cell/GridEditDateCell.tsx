...
import InputBase, {
  InputBaseProps,
} from "@cronoslogistics/hive-tablepro/core/mui-material/src/InputBase";
import {
...
function GridEditDateCell(props: GridEditDateCellProps) {
  ...
  const maxDate = apiRef.current.getColumn(field).maxDate;
  const minDate = apiRef.current.getColumn(field).minDate;
