...
interface GridBodyProps {
  ...
  virtualScrollerProps?: React.HTMLAttributes<HTMLDivElement>;
}

function GridBody(props: GridBodyProps) {
  const { children, VirtualScrollerComponent, ColumnHeadersComponent, virtualScrollerProps } = props;
...
GridBody.propTypes = {
  ...
  virtualScrollerProps: PropTypes.object,
} as any;
