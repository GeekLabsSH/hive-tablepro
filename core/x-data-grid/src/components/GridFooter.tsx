...
const GridFooter = React.forwardRef<HTMLDivElement, GridFooterContainerProps>(function GridFooter(
  ...
  const footerTotalizerByCurrency =
    rootProps?.footerTotalizerByCurrency ? (
      <div style={{ flex: '1', fontWeight: 'bold', fontSize: '10pt' }}>
        {rootProps?.footerTotalizerByCurrency}
      </div>
    ) : (
      <div />
...
GridFooter.propTypes = {
  ...
  footerTotalizerByCurrency: PropTypes.string
} as any;
