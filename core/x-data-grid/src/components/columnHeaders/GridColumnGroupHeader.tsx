...
const useUtilityClasses = (ownerState: OwnerState) => {
  const { classes, headerAlign, isDragging, showColumnBorder, groupId } =
    ownerState;
...
function GridColumnGroupHeader(props: GridColumnGroupHeaderProps) {
  ...
  const columnGroupsLookup = useGridSelector(
    apiRef,
    gridColumnGroupsLookupSelector
  );

  const group: Partial<GridColumnGroup> = groupId
  ...
  const publish = React.useCallback(
    (eventName: keyof GridColumnGroupHeaderEventLookup) =>
