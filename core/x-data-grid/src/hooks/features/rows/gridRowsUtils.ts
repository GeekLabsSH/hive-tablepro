...
import {
  GridRowIdToIdLookup, GridRowIdToModelLookup, GridRowsFullUpdate,
  GridRowsInternalCache, GridRowsPartialUpdateAction, GridRowsPartialUpdates,
  GridRowsState,
...
export const updateCacheWithNewRows = ({
  ...
  if (previousCache.updates.type === 'full') {
    throw new Error('HIVE: Unable to prepare a partial update if a full update is not applied yet');
  }
