...
export const useGridEditing = (
  ...
  const setEditCellValue = React.useCallback<
    GridEditingApi["setEditCellValue"]
  >(
    (params) => {
  ...
  const setEditCellValueManual = React.useCallback<
    GridEditingApi["setEditCellValueManual"]
  >(
    (params) => {
      const { id, field, debounceMs } = params;
      return new Promise((resolve) => {
  ...
  const getEditCellMeta = React.useCallback<
    GridEditingSharedApi["unstable_getEditCellMeta"]
  >(
    (id, field) => {
