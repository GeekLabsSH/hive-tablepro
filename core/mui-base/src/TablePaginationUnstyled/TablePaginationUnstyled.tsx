...
const useUtilityClasses = () => {
  ...
  return compClasses(slots, getTablePaginationUnstyledUtilityClass, {});
};
 ...
 */
const TablePaginationUnstyled = React.forwardRef<
  unknown,
  TablePaginationUnstyledProps
...
TablePaginationUnstyled.propTypes /* remove-proptypes */ = {
  ...
  page: chainPropTypes(integerPropType.isRequired, (props) => {
    ...
    if (page < 0 || page > newLastPage) {
      return new Error(
        "HIVE: The page prop of a TablePaginationUnstyled is out of range " +
