...
const useUtilityClasses = (ownerState: {
  ...
  return compClasses(slots, getTabUnstyledUtilityClass, {});
};
/**
 *
 * Demos:
 ...
 */
const TabUnstyled = React.forwardRef<unknown, TabUnstyledProps>(
  function TabUnstyled(props, ref) {
    const {
      action,
      children,
      value: valueProp,
    ...
    const tabRootProps: WithOptionalOwnerState<TabUnstyledRootSlotProps> =
      useSlotProps({
        elementType: TabRoot,
