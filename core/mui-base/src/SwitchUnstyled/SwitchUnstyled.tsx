...
const useUtilityClasses = (ownerState: SwitchUnstyledOwnerState) => {
  ...
  return compClasses(slots, getSwitchUnstyledUtilityClass, {});
};
...
>(props: SwitchUnstyledProps<BaseComponentType>, ref: React.ForwardedRef<any>) {
  ...
  const rootProps: WithOptionalOwnerState<SwitchUnstyledRootSlotProps> =
    useSlotProps({
      elementType: Root,
  ...
  const thumbProps: WithOptionalOwnerState<SwitchUnstyledThumbSlotProps> =
    useSlotProps({
      elementType: Thumb,
  ...
  const inputProps: WithOptionalOwnerState<SwitchUnstyledInputSlotProps> =
    useSlotProps({
      elementType: Input,
  ...
  const Track: React.ElementType =
    slots.track === null ? () => null : slots.track ?? "span";
  const trackProps: WithOptionalOwnerState<SwitchUnstyledTrackSlotProps> =
    useSlotProps({
      elementType: Track,
