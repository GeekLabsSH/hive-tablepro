...
export interface ExportedDateTimePickerToolbarProps
...
const useUtilityClasses = (
  ownerState: DateTimePickerToolbarProps<any> & { theme: Theme }
) => {
  ...
  const slots = {
    ...
    timeContainer: [
      "timeContainer",
      theme.direction === "rtl" && "timeLabelReverse",
    ],
    separator: ["separator"],
  };

  return compClasses(slots, getDateTimePickerToolbarUtilityClass, classes);
};
...
function DateTimePickerToolbar<TDate extends unknown>(
