...
export interface TimePickerToolbarProps<TDate>
  extends BaseToolbarProps<TDate | null, TimeView> {
  ampm?: boolean;
  ampmInClock?: boolean;
  classes?: Partial<TimePickerToolbarClasses>;
}

export interface ExportedTimePickerToolbarProps
...
const useUtilityClasses = (
  ownerState: TimePickerToolbarProps<any> & { theme: Theme }
) => {
  ...
  return compClasses(slots, getTimePickerToolbarUtilityClass, classes);
};
...
function TimePickerToolbar<TDate extends unknown>(
  inProps: TimePickerToolbarProps<TDate>
) {
...
TimePickerToolbar.propTypes = {
  ...
  views: PropTypes.arrayOf(
    PropTypes.oneOf(["day", "hours", "minutes", "month", "seconds", "year"])
      .isRequired
  ).isRequired,
} as any;
