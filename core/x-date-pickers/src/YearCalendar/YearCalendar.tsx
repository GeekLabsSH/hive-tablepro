...
import { useTheme } from "@cronoslogistics/hive-tablepro/core/mui-system/src";
import {
...
const useUtilityClasses = (ownerState: YearCalendarProps<any>) => {
  ...
  return compClasses(slots, getYearCalendarUtilityClass, classes);
};
...
type YearCalendarComponent = (<TDate>(
  props: YearCalendarProps<TDate>
) => JSX.Element) & {
  propTypes?: any;
};
