...
export interface PickersCalendarHeaderSlotsComponent
...
const useUtilityClasses = (
  ...
  return compClasses(slots, getPickersCalendarHeaderUtilityClass, classes);
};
 ...
 */
export function PickersCalendarHeader<TDate>(
  ...
  const switchViewButtonProps = useSlotProps({
    ...
    externalSlotProps:
      slotProps?.switchViewButton ?? componentsProps?.switchViewButton,
    additionalProps: {
      size: "small",
  ...
  const { ownerState: switchViewIconOwnerState, ...switchViewIconProps } =
    useSlotProps({
      ...
      externalSlotProps:
        slotProps?.switchViewIcon ?? componentsProps?.switchViewIcon,
