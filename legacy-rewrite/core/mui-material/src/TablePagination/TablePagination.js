...
const TablePaginationToolbar = styled(Toolbar, {
  ...
  color: document.body.dataset.theme === "light" ? "#495057" : "#C1C2C5",
  minHeight: 52,
  paddingRight: 2,
...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getTablePaginationUtilityClass, classes);
};
...
TablePagination.propTypes /* remove-proptypes */ = {
  ...
  page: chainPropTypes(integerPropType.isRequired, (props) => {
    ...
    if (page < 0 || page > newLastPage) {
      return new Error(
        "HIVE: The page prop of a TablePagination is out of range " +
