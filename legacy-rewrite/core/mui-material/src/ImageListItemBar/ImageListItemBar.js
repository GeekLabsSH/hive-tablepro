...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getImageListItemBarUtilityClass, classes);
};
...
const ImageListItemBar = React.forwardRef(function ImageListItemBar(
  inProps,
  ref
) {
  ...
  return (
    ...
    >
      ...
      >
        <ImageListItemBarTitle className={classes.title}>
          {title}
