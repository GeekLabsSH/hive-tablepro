...
const useUtilityClasses = (ownerState) => {
  ...
  return compClasses(slots, getPopoverUtilityClass, classes);
};
  ...
  const getAnchorOffset = React.useCallback(() => {
    if (anchorReference === "anchorPosition") {
      if (process.env.NODE_ENV !== null) {
        if (!anchorPosition) {
          console.error(
            "HIVE: You need to provide a `anchorPosition` prop when using " +
    ...
    if (process.env.NODE_ENV !== null) {
      ...
      if (
        ...
        console.warn(
          [
            "HIVE: The `anchorEl` prop provided to the component is invalid.",
    ...
    (element) => {
      ...
      if (process.env.NODE_ENV !== null) {
        if (
          ...
          console.error(
            [
              "HIVE: The popover component is too tall.",
    ...
    >
      ...
      >
        <PopoverPaper
          ...
          {...(isPositioned
            ? undefined
            : { style: { ...PaperProps.style, opacity: 0 } })}
          ownerState={ownerState}
        >
          {children}
        </PopoverPaper>
