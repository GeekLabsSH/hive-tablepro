...
import {
  GridColumnLookup, GridColumnRawLookup,
  GridColumnVisibilityModel,
  GridColumnsInitialState, GridColumnsRawState, GridColumnsState
} from './gridColumnsInterfaces';
import { gridColumnVisibilityModelSelector, gridColumnsStateSelector } from './gridColumnsSelector';
    ...
    if (existingState == null) {
      ...
      if (newColumn.type) {
        if (
          ...
          console.warn(
            [
              `HIVE: The column type "${newColumn.type}" you are using is not supported.`,
