...
export type GridCellModesModelProps =
  | ({ mode: GridCellModes.View } & Omit<
      GridStopCellEditModeParams,
      "id" | "field"
    >)
  | ({ mode: GridCellModes.Edit } & Omit<
...
export type GridCellModesModel = Record<
  GridRowId,
  Record<string, GridCellModesModelProps>
>;

export type GridRowModesModelProps =
  | ({ mode: GridRowModes.View } & Omit<
      GridStopRowEditModeParams,
      "id" | "field"
    >)
  | ({ mode: GridRowModes.Edit } & Omit<
