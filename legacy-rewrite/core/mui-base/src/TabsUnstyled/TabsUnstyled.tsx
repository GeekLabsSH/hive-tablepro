...
const useUtilityClasses = (ownerState: {
  ...
  return compClasses(slots, getTabsUnstyledUtilityClass, {});
};
 ...
 */
const TabsUnstyled = React.forwardRef<unknown, TabsUnstyledProps>(
  (props, ref) => {
    const {
      children,
      value: valueProp,
    ...
    const tabsRootProps: WithOptionalOwnerState<TabsUnstyledRootSlotProps> =
      useSlotProps({
