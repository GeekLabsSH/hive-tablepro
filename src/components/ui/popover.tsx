...
const OVERLAY_FOREGROUND_Z_INDEX = "z-[10050]";
const OVERLAY_FOREGROUND_Z_INDEX_INLINE = 2147483000;
      ...
      <PopoverPrimitive.Content
        ...
        {...({
          ...
          className: cn(
            ...
            OVERLAY_FOREGROUND_Z_INDEX,
            className
          ),
          ...props,
          style: { zIndex: OVERLAY_FOREGROUND_Z_INDEX_INLINE, ...((props as any)?.style ?? {}) }
        } as any)}
      />
    </PopoverPrimitive.Portal>
  )
