...
const DialogOverlay = React.forwardRef<HTMLDivElement, DialogOverlayProps>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    {...(props as any)}
  />
)) as typeof DialogPrimitive.Overlay;
...
) as typeof DialogPrimitive.Content;
DialogContent.displayName = DialogPrimitive.Content.displayName;

const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-1.5 text-center sm:text-left", className)} {...(props as any)} />
);
...
const DialogTitle = React.forwardRef<HTMLHeadingElement, DialogTitleProps>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ...
    {...(props as any)}
  />
)) as typeof DialogPrimitive.Title;
...
) as typeof DialogPrimitive.Description;
